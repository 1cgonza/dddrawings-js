import { audio } from '../http/req';

export class Audio {
  constructor(audios, cb) {
    if (
      !audios ||
      Object.prototype.toString.call(audios) !== '[object Object]'
    ) {
      return console.error(
        'The first parameter needs to be an Object.',
        'Example:',
        "{audio1: 'audio1.mp3', audio2: 'audio2.mp3'}"
      );
    }
